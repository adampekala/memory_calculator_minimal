...
gamePanelHTMLElements.btnStartCheckGood.addEventListener(
  "click",
  (ev: MouseEvent) => {
    switch (true) {
      case APPLICATION.gameState === "start": {
        ...
        gamePanelHTMLElements.btnStartCheckGood.classList.remove(
          "controlButton-green"
        );
      ...
      case APPLICATION.gameState === "check": {
        ...
        gamePanelHTMLElements.btnStartCheckGood.classList.add(
          "controlButton-green"
        );
      ...
      case APPLICATION.gameState === "asses": {
        ...
        if (APPLICATION.gameScore >= APPLICATION.gameStopLimit) {
          ...
          gamePanelHTMLElements.buttonMenu.classList.remove(
            "controlButton-red"
          );
          gamePanelHTMLElements.buttonMenu.classList.add("controlButton-menu");
